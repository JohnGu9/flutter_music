...
// This is custom page route that modifier from cupertino page route.
// Feature with vertical route gesture control and transparent background.
// Previous page route would be appear beneath this page route.
...
const _routeControllerMaxValue = 1.0 - 0.00001;
const _routeControllerMinValue = 0.1;

//const _customCurve = CustomCurve();
...
//      end: AlignmentDirectional.centerEnd,
      ...
      begin: AlignmentDirectional(0.0, 0.90),
...
class CustomCupertinoPageRoute<T> extends PageRoute<T> {
  ...
  /// is not a [CustomCupertinoPageRoute].
  ///
  /// See also:
  ///
  ...
  void didChangePrevious(Route<dynamic> previousRoute) {
    final String previousTitleString =
        previousRoute is CustomCupertinoPageRoute ? previousRoute.title : null;
  ...
  ///
  /// Used by [CustomCupertinoPageRoute.buildTransitions].
  ///
  /// This method can be applied to any [PageRoute], not just
  /// [CustomCupertinoPageRoute]. It's typically used to provide a Cupertino style
...
const Curve InCurve = Curves.fastOutSlowIn;
...
//  HorizontalDragGestureRecognizer _recognizer;
  ...
  static const slideCompensation = 1.5;
...
//        _convertToLogical(details.primaryDelta / context.size.width));
    _backGestureController.dragUpdate(
        details.primaryDelta / context.size.height * slideCompensation);
  }
...
//        details.velocity.pixelsPerSecond.dx / context.size.width));
    _backGestureController.dragEnd(details.velocity.pixelsPerSecond.dy /
        context.size.height *
        slideCompensation);
...
///
/// This is created by a [CustomCupertinoPageRoute] in response from a gesture caught
...
class _CupertinoBackGestureController<T> {
  ...
  void dragEnd(double velocity) {
    ...
    // animations.
    // const Curve animationCurve = Curves.bounceOut;
    const Curve animationToCurve = Curves.easeInToLinear;
